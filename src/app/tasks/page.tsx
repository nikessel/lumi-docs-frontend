            ...
            <div>
                ...
                <div className="flex flex-col mt-4">
                    {Array.from({ length: 20 }, (_, index) => (
                        <ReportMetaView key={index} report={null} loading={true} openRedirectPath="/tasks/overview/view" wasmModule={wasmModule} setActionLoading={setActionLoading} actionLoading={actionLoading} />
                    ))}
                </div>
            </div>
        );
