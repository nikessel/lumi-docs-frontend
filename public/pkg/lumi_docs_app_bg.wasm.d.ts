...
export function get_categories(): number;
export function get_files(): number;
export function get_requirements(): number;
export function get_sub_requirements(a: number): number;
