 ...
 */
export function exchange_code_for_identity(
  input: ExchangeCodeForIdentityInput,
): Promise<ExchangeCodeForIdentityResponse>;
/**
 * @param {TokenToClaimsInput} input
 * @returns {Promise<TokenToClaimsResponse>}
 */
export function token_to_claims(
  input: TokenToClaimsInput,
): Promise<TokenToClaimsResponse>;
/**
...
export function get_file_data(
  input: GetFileDataInput,
): Promise<GetFileDataResponse>;
/**
 * @param {UploadFileChunkInput} input
 * @returns {Promise<UploadFileChunkResponse>}
 */
export function upload_file_chunk(
  input: UploadFileChunkInput,
): Promise<UploadFileChunkResponse>;
/**
